...
from cvpods.data.datasets import (CityDataset, FoggyDataset, Sim10kDataset, KITTIDataset, CityCarDataset,
                                  City7clsDataset, Bdd100kDataset, FlirAlignRgb, FlirAlignIr, KaistPairedRgb,
                                  KaistPairedThermal)
...
class FullCity(CityDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'city_train')

#KaistAlignedRgb
class KaistPairedRgb(KaistPairedRgb):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'KaistPairedRgb_train')

# FlirAlignRgb
class FlirAlignRgb(FlirAlignRgb):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'FlirAlignRgb_train')



class FullSim10k(Sim10kDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'sim10k_train')


class FullKITTI(KITTIDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'kitti_train')


class FullCity7cls(City7clsDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'city_7cls_train')


class UnlabledFoggy(FoggyDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'foggy_train')

#unlable Kaist Paired
class UnlabledKaistPairedThermal1to1(KaistPairedThermal):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'KaistPairedThermal_train_1to1')

class UnlabledKaistPairedThermal1to2(KaistPairedThermal):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'KaistPairedThermal_train_1to2')

class UnlabledKaistPairedThermal1to4(KaistPairedThermal):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'KaistPairedThermal_train_1to4')

# unlable FlirAlignIR
class UnlabledFlirAlignIr1to1(FlirAlignIr):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'FlirAlignIr_train_1to1')

class UnlabledFlirAlignIr1to2(FlirAlignIr):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'FlirAlignIr_train_1to2')

class UnlabledFlirAlignIr1to4(FlirAlignIr):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'FlirAlignIr_train_1to4')

class UnlabledBdd100k(Bdd100kDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'bdd100k_train')


class UnlabledCityCar(CityCarDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'city_car_train')
